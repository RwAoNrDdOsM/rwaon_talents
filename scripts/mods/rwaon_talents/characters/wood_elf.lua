...
--Waystalker
--mod:dofile("scripts/mods/rwaon_talents/scripts/unit_extensions/weapons/actions/action_career_we_waystalker")
...
--Waystalker
mod:dofile("scripts/mods/rwaon_talents/scripts/managers/talents/talent_settings_kerillian_waywatcher")
