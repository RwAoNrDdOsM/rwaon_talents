...
mod:add_talent("we_maidenguard", 2, 3, "rwaon_kerillian_maidenguard_increased_attack_speed", {
	...
	requirements = {},
	buffs = {
			"rwaon_kerillian_maidenguard_attack_speed",
	},
	buff_data = {},
	icon = "kerillian_maidenguard_activated_ability_cooldown",	
})

--[[mod:add_talent_buff("wood_elf", "rwaon_kerillian_maidenguard_increased_attack_speed_on_high_health", {
	activation_health = 0.6,
	buff_to_add = "rwaon_kerillian_maidenguard_attack_speed_on_high_health",
	update_func = "activate_buff_on_health_percent",
})]]

mod:add_talent_buff("wood_elf", "rwaon_kerillian_maidenguard_attack_speed", {
	icon = "kerillian_maidenguard_activated_ability_cooldown",
	multiplier = 0.1,
